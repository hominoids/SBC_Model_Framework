...
module usb2(type, loc_x, loc_y, loc_z, side, rotation, size, data, pcbsize_z, enablemask, mask) {
        ...
        if(enablemask == true && cmask == true && mstyle == "default") {
            ...
            if(side == "top" && rotation == 0) {
                place(loc_x-.75, loc_y+back, loc_z+dia/2, size_x, size_y, rotation, side, pcbsize_z)
                    rotate([90, 0, 0]) slot(dia, wide, mlen);
            }
    ...
    if(type == "single_horizontal_a") {
        ...
        if(enablemask == true && cmask == true && mstyle == "default") {
            ...
            if(side == "top" && rotation == 90) {
                place(loc_x-mlen+back, loc_y+.5, loc_z, size_x, mlen, rotation, side, pcbsize_z)
                    cube([size_xm, mlen, size_zm]);
            }
            if(side == "top" && rotation == 180) {
                place(loc_x+.5, loc_y+size_y-back, loc_z, size_x, mlen, rotation, side, pcbsize_z)
                    cube([size_xm, mlen, size_zm]);
            }
            if(side == "top" && rotation == 270) {
                place(loc_x+size_y-back, loc_y-.5, loc_z, size_x, mlen, rotation, side, pcbsize_z)
                    cube([size_xm, mlen, size_zm]);
            }
            if(side == "bottom" && rotation == 0) {
                place(loc_x+.5, loc_y-mlen+back, loc_z, size_x, mlen, rotation, side, pcbsize_z)
    ...
    if(type == "single_vertical_a") {
        ...
        if(enablemask == true && cmask == true && mstyle == "default") {
            ...
            if(side == "top" && rotation == 90) {
                place(loc_x-mlen+back, loc_y+.8, loc_z, size_x, mlen, rotation, side, pcbsize_z)
                    cube([size_xm, mlen, size_zm]);
            }
            if(side == "top" && rotation == 180) {
                place(loc_x+.85, loc_y+size_y-back, loc_z, size_x, mlen, rotation, side, pcbsize_z)
                    cube([size_xm, mlen, size_zm]);
            }
            if(side == "top" && rotation == 270) {
                place(loc_x+size_y-back, loc_y-1, loc_z, size_x, mlen, rotation, side, pcbsize_z)
                    cube([size_xm, mlen, size_zm]);
            }
            if(side == "bottom" && rotation == 0) {
                place(loc_x+.85, loc_y-mlen+back, loc_z, size_x, mlen, rotation, side, pcbsize_z)
            ...
            if(side == "bottom" && rotation == 90) {
                place(loc_x+size_y-back, loc_y+.75, loc_z, size_x, mlen, rotation, side, pcbsize_z)
                    cube([size_xm, mlen, size_zm]);
            }
            if(side == "bottom" && rotation == 180) {
                place(loc_x-.85, loc_y+size_y-back, loc_z, size_x, mlen, rotation, side, pcbsize_z)
            ...
            if(side == "bottom" && rotation == 270) {
                place(loc_x-mlen+back, loc_y-1, loc_z, size_x, mlen, rotation, side, pcbsize_z)
                    cube([size_xm, mlen, size_zm]);
            }
        }
        if(enablemask == false) {
    ...
    if(type == "double_stacked_a") {
        ...
        if(enablemask == true && cmask == true && mstyle == "default") {
            ...
            if(side == "top" && rotation == 90) {
                place(loc_x-mlen+back, loc_y+.75, loc_z, size_x, mlen, rotation, side, pcbsize_z)
                    cube([size_xm, mlen, size_zm]);
            }
            if(side == "top" && rotation == 180) {
                place(loc_x+.75, loc_y+size_y-back, loc_z, size_x, mlen, rotation, side, pcbsize_z)
                    cube([size_xm, mlen, size_zm]);
            }
            if(side == "top" && rotation == 270) {
                place(loc_x+size_y-back, loc_y-.75, loc_z, size_x, mlen, rotation, side, pcbsize_z)
    ...
    if(type == "single_horizontal") {
        ...
        if(enablemask == true && cmask == true && mstyle == "default") {
            ...
            if((side == "top" && rotation == 90) || (side == "bottom" && rotation == 270)) {
                place(loc_x+back, loc_y, loc_z-.125+diam/2, size_x, mlen, rotation, side, pcbsize_z)
                    rotate([90, 0, 0]) slot(diam, size_xm, mlen);
            }
            if(rotation == 180) {
                place(loc_x, loc_y-1-back, loc_z+diam/2, size_x, mlen, rotation, side, pcbsize_z)
                    rotate([90, 0, 0]) slot(diam, size_xm, mlen);
            }
            if((side == "top" && rotation == 270) || (side == "bottom" && rotation == 90)) {
                place(loc_x-1-back, loc_y, loc_z+diam/2, size_x, mlen, rotation, side, pcbsize_z)
                    rotate([90, 0, 0]) slot(diam, size_xm, mlen);
            }
        }
        if(enablemask == false) {
    ...
    if(type == "single_vertical") {
        ...
        if(enablemask == true && cmask == true && mstyle == "default") {
            ...
            if((rotation == 90 && side == "top") || (rotation == 270 && side == "bottom")) {
                place(loc_x+back, loc_y+.125-diam/2, loc_z+size_xm+height, size_xm, mlen, rotation, side, pcbsize_z)
                    rotate([90, 90, 0]) slot(diam, size_xm, mlen);
            }
            if(side == "top" && rotation == 180) {
                place(loc_x-.75, loc_y-2-back, loc_z+size_xm+height, mlen, size_xm, rotation, side, pcbsize_z)
                    rotate([90, 90, 0]) slot(diam, size_xm, mlen);
            }
            if(side == "top" && rotation == 270) {
                place(loc_x-2-back, loc_y-.125+diam/2, loc_z+size_xm+height, mlen, size_xm, rotation, side, pcbsize_z)
                    rotate([90, 90, 0]) slot(diam, size_xm, mlen);
            }
            if(side == "bottom" && rotation == 0) {
                place(loc_x+.125-diam/2, loc_y+back, loc_z+size_xm+height, size_xm, mlen, rotation, side, pcbsize_z)
            ...
            if(side == "bottom" && rotation == 180) {
                place(loc_x-.125+diam/2, loc_y-2-back, loc_z+size_xm+height, mlen, size_xm, rotation, side, pcbsize_z)
                    rotate([90, 90, 0]) slot(diam, size_xm, mlen);
            }
        }
        if(enablemask == false) {
