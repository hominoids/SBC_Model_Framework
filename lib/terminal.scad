    ...
    if(type=="gtb") {
        ...
        if(enablemask == true && cmask == true && mstyle == "default") {
            if(side == "top" && rotation == 0) {
                ...
                union() {
                    translate([0,back,3]) rotate([90, 0, 0]) slot(5,size_x,len);
                    for(r=[pitch/2:pitch:size_x]) {
                        translate([r,4.15,height-back]) cylinder(d=3.7, h=len);
                    }
                }
            }
            ...
            if(side == "top" && rotation == 180) {
                place(loc_x, loc_y, loc_z, size_xm, size_ym, rotation, side, pcbsize_z)
                union() {
                    translate([2,1+back,3]) rotate([90, 0, 0]) slot(5,size_x,len);
                    for(r=[pitch/2:pitch:size_x]) {
                        translate([r+2,4.5,height-back]) cylinder(d=3.7, h=len);
                    }
                }
            }
            if(side == "top" && rotation == 270) {
                place(loc_x, loc_y, loc_z, size_xm, size_ym, rotation, side, pcbsize_z)
                union() {
                    translate([0,.5+back,3]) rotate([90, 0, 0]) slot(5,size_x,len);
                    for(r=[pitch/2:pitch:size_x]) {
                        translate([r,4.5,height-back]) cylinder(d=3.7, h=len);
                    }
                }
            }
            if(side == "bottom" && rotation == 0) {
                place(loc_x, loc_y, loc_z, size_xm, size_ym, rotation, side, pcbsize_z)
                union() {
                    translate([2,back,3]) rotate([90, 0, 0]) slot(5,size_x,len);
                    for(r=[pitch/2:pitch:size_x]) {
                        translate([r+2,4.15,height-back]) cylinder(d=3.7, h=len);
                    }
                }
            }
            if(side == "bottom" && rotation == 90) {
                place(loc_x, loc_y, loc_z, size_xm, size_ym, rotation, side, pcbsize_z)
                union() {
                    translate([2,.5+back,3]) rotate([90, 0, 0]) slot(5,size_x,len);
                    for(r=[pitch/2:pitch:size_x]) {
                        translate([r+2,4.5,height-back]) cylinder(d=3.7, h=len);
                    }
                }
            ...
            if(side == "bottom" && rotation == 180) {
                place(loc_x, loc_y, loc_z, size_xm, size_ym, rotation, side, pcbsize_z)
                union() {
                    translate([0,1+back,3]) rotate([90, 0, 0]) slot(5,size_x,len);
                    for(r=[pitch/2:pitch:size_x]) {
                        translate([r,4.5,height-back]) cylinder(d=3.7, h=len);
                    }
                }
