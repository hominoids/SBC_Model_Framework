...
jumper(410,40,0,"top","header_3x2",0);
linear_extrude(height = 1) {translate([410,30,0]) text("header_3x2",size=5, halign="left");}
jumper(410,60,0,"top","header_5x1",0);
linear_extrude(height = 1) {translate([410,50,0]) text("header_5x1",size=5, halign="left");}
jumper(410,80,0,"top","header_6x1",0);
linear_extrude(height = 1) {translate([410,70,0]) text("header_6x1",size=5, halign="left");}
jumper(410,100,0,"top","header_7x1",0);
linear_extrude(height = 1) {translate([410,90,0]) text("header_7x1",size=5, halign="left");}
...
misc(500,80,0,"lcd_2.2",0);
linear_extrude(height = 1) {translate([500,70,0]) text("lcd_2.2",size=5, halign="left");}
